            ...
            <div className="max-w-5xl mx-auto space-y-6">
              ...
              <Card id="kinoklub-subektiv" className="border-2 border-primary/30 bg-gradient-to-br from-primary/5 to-accent/5 hover:shadow-xl transition-all duration-300 scroll-mt-20">
                <CardContent className="p-8 space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Это пространство, где мы смотрим кино и изучаем себя, находим и создаём смыслы увиденного. Мы смотрим на кино, как на эстетический объект, через который можно осмыслить свой субъективный опыт.
                  </p>
