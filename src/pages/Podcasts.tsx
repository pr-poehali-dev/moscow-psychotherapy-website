  ...
  const podcasts = [
    {
      ...
      hosts: [
        ...
        { name: 'Шмакова Евгения Владимировна', role: 'Клинический психолог, криминальный психолог, заместитель директора Союза охраны психического здоровья. Преподаватель АНО ДПО "НОЦ СМТ", действительный член МО РПА' },
    ...
    {
      id: 2,
      title: 'Саморазвитие против жизни: тренд, зависимость или путь к свободе?',
      episodeNumber: 2,
      hosts: [
        { name: 'Мальцева Екатерина Витальевна', role: 'Исполнительный директор МО РПА, директор Союза охраны психического здоровья, директор АНО ДПО "НОЦ СМТ", клинический психолог' },
        { name: 'Шмакова Евгения Владимировна', role: 'Клинический психолог, криминальный психолог, заместитель директора Союза охраны психического здоровья. Преподаватель АНО ДПО "НОЦ СМТ", действительный член МО РПА' },
      ...
      category: 'Популярная психология',
      description: 'Во втором эпизоде обсуждаем феномен саморазвития: где грань между полезным инструментом и зависимостью? Разбираем популярные тренды и их влияние на психику.',
      topics: [
        'Саморазвитие как современный тренд',
        'Когда саморазвитие становится зависимостью?',
        'Путь к настоящей свободе или иллюзия контроля?'
      ],
      duration: '45 мин',
      rutubeUrl: 'https://rutube.ru/video/777165c6c6efcda925713e57a6a38bb4/',
      coverImage: 'https://cdn.poehali.dev/projects/bc3131c3-820e-44dd-91d7-c241696bb6f9/bucket/840d7e71-5bff-4dd8-827c-689bf1dbf525.png',
      isPaid: false,
    },
    {
      id: 3,
      title: 'Суд над трендом личных границ',
      episodeNumber: 3,
      hosts: [
        { name: 'Мальцева Екатерина Витальевна', role: 'Исполнительный директор МО РПА, директор Союза охраны психического здоровья, директор АНО ДПО "НОЦ СМТ", клинический психолог' },
        { name: 'Шмакова Евгения Владимировна', role: 'Клинический психолог, криминальный психолог, заместитель директора Союза охраны психического здоровья. Преподаватель АНО ДПО "НОЦ СМТ", действительный член МО РПА' },
      ...
      category: 'Популярная психология',
      description: 'В третьем эпизоде продолжаем разбирать феномен популярной психологии и её влияние на современное общество.',
      topics: [
        'Психология в современном мире',
        'Критический взгляд на популярные тренды',
        'Научный подход vs массовая психология'
      ],
      duration: '45 мин',
      rutubeUrl: 'https://rutube.ru/video/f4d314a131f0fbe17401895efaf3aa00/',
      coverImage: 'https://cdn.poehali.dev/projects/bc3131c3-820e-44dd-91d7-c241696bb6f9/bucket/840d7e71-5bff-4dd8-827c-689bf1dbf525.png',
      isPaid: false,
    },
    {
      id: 4,
      title: 'Выгорание: кто виноват?',
      episodeNumber: 4,
      hosts: [
        { name: 'Мальцева Екатерина Витальевна', role: 'Исполнительный директор МО РПА, директор Союза охраны психического здоровья, директор АНО ДПО "НОЦ СМТ", клинический психолог' },
        { name: 'Шмакова Евгения Владимировна', role: 'Клинический психолог, криминальный психолог, заместитель директора Союза охраны психического здоровья. Преподаватель АНО ДПО "НОЦ СМТ", действительный член МО РПА' },
      ...
      category: 'Популярная психология',
      description: 'В четвёртом эпизоде продолжаем обсуждение психологии как феномена современного общества.',
      topics: [
        'Психология в массовом сознании',
        'Роль психологии в современной культуре',
        'Границы профессионализма'
      ],
      duration: '45 мин',
      rutubeUrl: 'https://rutube.ru/video/ce41a6240c8322c77564a82c79c54f16/',
      coverImage: 'https://cdn.poehali.dev/projects/bc3131c3-820e-44dd-91d7-c241696bb6f9/bucket/840d7e71-5bff-4dd8-827c-689bf1dbf525.png',
      isPaid: false,
    },
    {
    ...
    {
      id: 6,
      title: 'Критическое мышление: Спаситель или тиран?',
      episodeNumber: 6,
      hosts: [
        { name: 'Мальцева Екатерина Витальевна', role: 'Исполнительный директор МО РПА, директор Союза охраны психического здоровья, директор АНО ДПО "НОЦ СМТ", клинический психолог' },
        { name: 'Шмакова Евгения Владимировна', role: 'Клинический психолог, криминальный психолог, заместитель директора Союза охраны психического здоровья. Преподаватель АНО ДПО "НОЦ СМТ", действительный член МО РПА' },
      ...
      category: 'Популярная психология',
      description: 'В шестом эпизоде разбираем критическое мышление: помогает ли оно или становится препятствием?',
      topics: [
        'Что такое критическое мышление',
        'Польза и ограничения критического подхода',
        'Когда критичность переходит границы'
      ],
      duration: '45 мин',
      rutubeUrl: 'https://rutube.ru/video/a4902e73d09be01c18106009ecd19beb/',
      coverImage: 'https://cdn.poehali.dev/projects/bc3131c3-820e-44dd-91d7-c241696bb6f9/bucket/840d7e71-5bff-4dd8-827c-689bf1dbf525.png',
      isPaid: false,
    },
  ];
