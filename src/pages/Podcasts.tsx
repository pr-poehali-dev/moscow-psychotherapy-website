  ...
  const podcasts = [
    {
      ...
      episodeNumber: 1,
      hosts: [
        { name: 'Мальцева Екатерина Витальевна', role: 'Директор Союза охраны психического здоровья, директор АНО ДПО "НОЦ СМТ", клинический психолог' },
        { name: 'Шмакова Евгения Владимировна', role: 'Клинический психолог, криминальный психолог, заместитель директора Союза охраны психического здоровья. Преподаватель Научно-образовательного центра современных медицинских технологий (НОЦ СМТ), член Российской психотерапевтической ассоциации (РПА)', specialistId: 43 },
