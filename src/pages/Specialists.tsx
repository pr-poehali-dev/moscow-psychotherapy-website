...
const Specialists = () => {
  ...
  const specialists = [
    ...
    },
    {
      ...
      photo: '👩‍⚕️',
      location: 'Москва',
      education: 'Российский государственный социальный университет (социальная психология)',
      specialty: 'Клинический психолог',
      approach: 'Гештальт-терапия, экзистенциальная психотерапия, семейная системная психотерапия',
      workplace: 'Частная практика',
      phone: '+7 925 125-00-85',
      website: 'http://arhangel.space/',
      email: 'natatambov00@mail.ru',
