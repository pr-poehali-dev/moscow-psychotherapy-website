  ...
  const specialists = [
    {
      ...
      photo: '👩‍⚕️',
      workplace: 'Центр психологической помощи "Гармония"',
      contacts: '+7 (495) 123-45-67, ivanova@example.com',
      education: 'МГУ им. М.В. Ломоносова',
      specialization: 'Клиническая психология',
      degree: 'Кандидат психологических наук',
      approaches: ['Когнитивно-поведенческая терапия'],
      ageGroups: ['Взрослые', 'Подростки'],
      mainIssues: ['Тревожные расстройства', 'Депрессия'],
