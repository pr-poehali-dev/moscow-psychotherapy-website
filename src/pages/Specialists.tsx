  ...
  const specialists = [
    {
      ...
      photo: '/specialists/azovskih_svetlana_valerevna.jpg',
      location: 'Москва',
    ...
    },
    {
      ...
      website: 'https://t.me/mitserge_psy',
      email: 'mitserge@mitserge.ru',
    ...
    },
    {
      ...
      approach: 'Клиническая психотерапия; Психоаналитическая психотерапия; Кризисная психотерапия; Перинатальная психотерапия; ДПДГ-терапия; Нарративная и психолингвистическая терапия; Интегративная (мультимодальная) супервизия',
      workplace: 'Частная практика',
    ...
    },
    {
      ...
      location: 'Москва',
      education: 'НИУ "Высшая школа экономики". Диплом магистра с отличием по направлению подготовки 37.04.01 Психология (1660 ак. час.), 2024 г. РГГУ. Диплом о профессиональной переподготовке удостоверяющий право на ведение профессиональной деятельности в сфере психологии личности (650 ак. час.), 2022 г. НОЧУ ВО Московский институт психоанализа, г. Москва. Программа: Клиническая психология. Сфера деятельности: Клинический психолог. Продолжительность: 1500 часов. Год получения: 2026.',
      specialty: 'Клинический психолог',
      approach: 'Психоаналитическая психотерапия',
      workplace: 'Частная практика',
    ...
    },
    {
      ...
      specialty: 'Психолог',
      approach: 'Гештальт-терапия, эмоционально-фокусированная терапия супружеских пар, групповая гештальт-терапия, работа с психосоматикой в гештальт-подходе',
      workplace: 'Частная практика',
    ...
    },
    {
      ...
      phone: 'WA: +7 964 774-12-10',
      website: '',
      email: 'AL.AL.PSY@yandex.ru',
      mainIssues: [],
      ageGroups: 'Взрослые',
      approaches: ['Психоаналитическая терапия'],
      status: 'Действительный член РПА',
    ...
    },
    {
      ...
      photo: 'https://cdn.poehali.dev/projects/bc3131c3-820e-44dd-91d7-c241696bb6f9/bucket/bb20d5bb-8117-4a96-980f-5c4c4b1f4593.jpg',
      location: 'Москва',
    ...
    },
    {
      ...
      workplace: 'Научный сотрудник НИУ ВШЭ, частная практика',
    ...
    },
    {
      ...
      photo: 'https://cdn.poehali.dev/projects/bc3131c3-820e-44dd-91d7-c241696bb6f9/bucket/f341cfab-d456-4323-aba7-89ec208e2058.jpg',
      location: 'Москва',
    ...
    },
    {
      ...
      specialty: 'Психолог, преподаватель психологии',
      approach: 'Телесно-ориентированная психотерапия',
      workplace: 'Частная практика, Московский институт психоанализа, Институт психотерапии и клинической психотерапии',
      phone: '+7 914 852-05-10',
      website: 'https://t.me/hakomiru',
      email: 'anntorgasheva@gmail.com',
      mainIssues: ['Травмы развития', 'Депрессия', 'КПТСР', 'Домашнее насилие', 'Детско-родительские отношения взрослых людей', 'Формирование здоровых границ', 'Шоковые травмы'],
      ageGroups: 'С 18 до 60 лет',
      approaches: ['Телесно-ориентированная терапия'],
      status: 'Действительный член РПА',
    },
    {
      ...
      education: 'Высшее',
      specialty: 'Клиническая психология',
      approach: 'Экзистенциальный подход',
      workplace: 'Частная практика',
      phone: '+7 916 854-97-49',
      website: 'https://www.b17.ru/alla_vaulina/',
      email: 'alla_indi@mail.ru',
      mainIssues: ['Кризисы жизни, страх смерти, утрата жизненного смысла/ценностей, экзистенциальные кризисы', 'Сопровождение горя и утраты (в том числе патологическое горе), проживание развода, расставаний', 'Тревожные, депрессивные состояния (в том числе с установленными диагнозами)', 'Сложные чувства (стыд, вина, обида)', 'Отношение к себе, самокритика, самооценка, связь со своими ценностями', 'Травматический опыт (включая ПТСР и КПТСР)', 'Проблемы в отношениях с другими людьми, зависимое поведение'],
      ageGroups: 'Взрослые (с 18 лет)',
      approaches: ['Экзистенциальный подход'],
      status: 'Действительный член РПА',
    },
  ];

  const issueCategories = [
    { value: 'тревог|страх|паническ|фоби', label: 'Тревога, страхи, панические атаки' },
    { value: 'депресс|апати|подавленн|уныни|тоск', label: 'Депрессия и апатия' },
    { value: 'стресс|выгорани|устал|нехватка сил|отсутствие энерги', label: 'Стресс, выгорание, усталость' },
    { value: 'травм|птср|кптср|шоков|неблагоприятного детского опыта', label: 'Травма и ПТСР' },
    { value: 'насили|абьюз|домогательств', label: 'Насилие' },
    { value: 'самооцен|уверенност|самокритик|внутренний критик|собственной ценности|незаметности|самосаботаж', label: 'Самооценка и неуверенность в себе' },
    { value: 'отношени|паре|партнер|любовн|близост|вступать в отношени|конфликт|сценари', label: 'Отношения и близость' },
    { value: 'детско-родительск|родител', label: 'Детско-родительские отношения' },
    { value: 'семейн|развод|расставани|семь', label: 'Семья и развод' },
    { value: 'зависим|алкогол|наркотич|игроман', label: 'Зависимости' },
    { value: 'кризис|эмиграц|переезд|адаптац|нестабильн', label: 'Жизненные кризисы и переходы' },
    { value: 'утрат|гор|потер|смерт|скорбь', label: 'Утрата и горе' },
    { value: 'психосоматик|соматич|аллерги|кишечник', label: 'Психосоматика' },
    { value: 'пищевого поведения|рпп|снижения веса', label: 'Расстройства пищевого поведения' },
    { value: 'сепараци|границ|отстоять свое мнение', label: 'Сепарация и личные границы' },
    { value: 'идентичн|поиск себя|самоопредел|самопознан|смысл|экзистенциальн|пустоты|проходит мимо|поиски себя', label: 'Поиск себя и смысл жизни' },
    { value: 'сексуальн|секс', label: 'Сексуальные трудности' },
    { value: 'одиночеств', label: 'Одиночество' },
    { value: 'созависим', label: 'Созависимость' },
    { value: 'прл|нрл|нарцисс|личностные расстройства', label: 'Личностные расстройства (ПРЛ, НРЛ)' },
    { value: 'суицидальн', label: 'Суицидальные мысли' },
    { value: 'гнев|раздражит|агресси', label: 'Гнев и раздражительность' },
    { value: 'перфекцион|прокрастинац|требовательност', label: 'Перфекционизм и прокрастинация' },
    { value: 'навязчив|окр\\)|обсессивно', label: 'Навязчивые мысли (ОКР)' },
    { value: 'карьер|профессиональн|деньги', label: 'Карьера и самореализация' },
    { value: 'беремен|эко,|бесплоди|перинатальн|материнств', label: 'Беременность и репродуктивное здоровье' },
    { value: 'шизофрен|бар,|психотическ|психиатр|ментальной инвалидност', label: 'Тяжёлые психические расстройства' },
    { value: 'эмоционал|перепады настроения|захваченност|контроле эмоций', label: 'Эмоциональная регуляция' },
    { value: 'стыд| вин', label: 'Стыд и вина' },
    { value: 'медиац|работа с семьями', label: 'Медиация и работа с семьёй' },
    { value: 'подростков', label: 'Подростковая психология' },
    { value: 'токсичн', label: 'Токсичное окружение' },
    { value: 'социальн', label: 'Социальное взаимодействие' },
    { value: 'принятием решен', label: 'Трудности с принятием решений' },
  ];
    ...
    .filter((specialist) => {
      ...
      const matchesIssue = 
        ...
        specialist.mainIssues.some(issue => 
          new RegExp(selectedIssue, 'i').test(issue)
        );
